...
description="Sunday School is the heart of our faith formation ministry. We provide structured, age-appropriate religious education for children and young people, helping them understand the teachings of the Gospel and develop a deeper connection with Christ and the Church."
      ...
      extraContent={
        <div>
          <div className="mb-10 rounded-xl border border-gold/20 bg-[#faf7f2] p-7 text-center">
            <h2 className="font-serif text-2xl text-gray-900 mb-2">Sunday School Portal</h2>
            <p className="text-gray-600 text-sm mb-4">Students, servants, and parents sign in with their ID and PIN for attendance, points, and class updates.</p>
            <a href="/portal/login" className="inline-flex items-center justify-center rounded-lg bg-primary-900 px-6 py-3 font-semibold text-white hover:bg-primary-950 transition-colors">
