  ...
  return (
    <ServicePageLayout
      ...
      images={[
        ...
        { src: '/images/youth6.jpg', alt: 'Youth gathering' },
        { src: '/images/youth7.jpg', alt: 'Youth fellowship' },
        { src: '/images/youth8.jpg', alt: 'Youth community' },
        { src: '/images/youth9.jpg', alt: 'Youth activities' },
      ]}
