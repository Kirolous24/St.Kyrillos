          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-primary-50 rounded-xl p-6 border border-primary-100">
              ...
              <p className="text-gray-700">
                All men of the parish and community who desire to grow spiritually and connect with other men in faith.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="rounded-xl overflow-hidden bg-gray-200 aspect-video flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-500 text-sm">Men's gathering</p>
                </div>
              </div>
              <div className="rounded-xl overflow-hidden bg-gray-200 aspect-video flex items-center justify-center">
                <div className="text-center">
                  <p className="text-gray-600 font-medium">[Image 2]</p>
                  <p className="text-gray-500 text-sm">Bible study</p>
                </div>
              </div>
              <div className="rounded-xl overflow-hidden bg-gray-200 aspect-video flex items-center justify-center">
                <div className="text-center">
                  <p className="text-gray-600 font-medium">[Image 3]</p>
                  <p className="text-gray-500 text-sm">Service project</p>
                </div>
              </div>
            </div>
          </div>
