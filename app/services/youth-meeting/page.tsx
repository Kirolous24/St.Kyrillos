        ...
        <div className="container-custom max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-primary-50 rounded-xl p-6 border border-primary-100">
              ...
              <p className="text-gray-700">
                Young adults ages [AGE RANGE - typically 18-35], whether they've grown up in the Church or are new to our community.
              </p>
            </div>
            ...
            <div className="bg-green-50 rounded-xl p-6 border border-green-100">
              ...
              <p className="text-gray-700 text-sm">
                Location: Church Hall/Fellowship Area
              </p>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="rounded-xl overflow-hidden bg-gray-200 aspect-video flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-500 text-sm">Youth gathering</p>
                </div>
              </div>
              <div className="rounded-xl overflow-hidden bg-gray-200 aspect-video flex items-center justify-center">
                <div className="text-center">
                  <p className="text-gray-600 font-medium">[Image 2]</p>
                  <p className="text-gray-500 text-sm">Bible study & discussion</p>
                </div>
              </div>
              <div className="rounded-xl overflow-hidden bg-gray-200 aspect-video flex items-center justify-center">
                <div className="text-center">
                  <p className="text-gray-600 font-medium">[Image 3]</p>
                  <p className="text-gray-500 text-sm">Community service</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-primary-900 to-primary-950 rounded-xl p-8 text-white text-center">
            ...
            <p className="text-white/80 mb-6 max-w-2xl mx-auto">
              Join a community of young adults who are serious about their faith and having fun together. All are welcome!
            </p>
          </div>
        </div>
      </section>
